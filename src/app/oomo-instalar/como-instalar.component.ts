      ...
      drivers: [
        {
          ...
          link: "http://erpdoccloud.com.br/downloads/Driver_Morpho_Win8_32bits.zip"
        },
        {
          nome: "Driver Safran Morpho (64 Bits)",
          especificacao: "Driver para sistemas de 32 Bits (Windows Xp, Vista, 7 e 8)",
          link: "http://erpdoccloud.com.br/downloads/Driver_Morpho_Win8_64bits.zip"
        }
      ]
    },
    {
      ...
      drivers: [
        {
          ...
          link: "http://erpdoccloud.com.br/downloads/61d47164c43dc6fa9f3ca946e4e33c48.msi"
        },
        {
          nome: "SafeNet Authentication Client 8.2 (64 Bits)",
          especificacao: "Driver para Microsoft Windows de 32 bits (XP, 2003, 2008, Vista, 7 e 8)",
          link: "http://erpdoccloud.com.br/downloads/027be019a9f512e4abf82aa96759e873.msi"
        },
        {
          ...
          link: "http://erpdoccloud.com.br/downloads/4be487476b1b387ce265ef45d2d4d1d6.rar"
        },
        {
          nome: "Mac OS X Snow Leopard e Lion",
          especificacao: "Mac OS X Snow Leopard e Lion",
          link: "http://erpdoccloud.com.br/downloads/142ee6d1cbd7266235fb62a0e9c5b181.zip"
        },
        {
          nome: "SafeNet Authentication Client 8.2 (Mac OS)",
          especificacao: "Driver para Mac OS",
          link: "http://erpdoccloud.com.br/downloads/2a0e2d7dcc7c2c314fb48ae5fe520101.zip"
        }
      ]
    },
    {
      ...
      drivers: [
        {
          ...
          link: "http://erpdoccloud.com.br/downloads/395fbe01325a4f664673f0a9cd1be354.exe"
        },
        {
          nome: "GD Starsign - GD Burti (64 Bits)",
          especificacao: "Driver para Microsoft Windows de 64 bits (XP, 2003, 2008, Vista, Seven)",
          link: "http://erpdoccloud.com.br/downloads/2d49cf949c9f4bf33e21c36ec7192bda.exe"
        }
      ]
    },
    {
      ...
      drivers: [
        {
          ...
          especificacao: "Driver para Microsoft Windows de 32 bits (XP, 2003, 2008, Vista, Seven)",
          link: "http://erpdoccloud.com.br/downloads/ce3297be8d62093f229722581da30f29.exe"
        },
        {
          nome: "Windows 64 bits (XP, 2003, 2008, Vista, Seven)",
          especificacao: "Driver para Microsoft Windows de 32 bits (XP, 2003, 2008, Vista, Seven)",
          link: "http://erpdoccloud.com.br/downloads/4f0bad5f47a1809ea3c017d7741e4ade.exe"
        },
        {
          nome: "SafeNet Authentication Client 8.1",
          especificacao: "Mac OS X Snow Leopard",
          link: "http://erpdoccloud.com.br/downloads/c98f1545dfd1cdcea48fed7107c2445a.rar"
        }
      ]
    },
    {
      ...
      drivers: [
        {
          ...
          link: "http://erpdoccloud.com.br/downloads/201110516312570555.exe"
        },
        {
          nome: "Windows 8, Windows 7, Vista, XP, 2008, 2003 (64 bits)",
          especificacao: "Driver para Microsoft Windows de 32 bits (XP, 2003, 2008, Vista, Seven, 8)",
          link: "http://erpdoccloud.com.br/downloads/201110516312553343.exe"
        },
        {
          nome: "Linux 32/64 bits",
          especificacao: "Driver para Linux 32/64 bits",
          link: "http://erpdoccloud.com.br/downloads/2011810151801402.zip"
        },
        {
          nome: "MAC OSX (10.5/10.6/10.7)",
          especificacao: "Driver para MAC OS X (10.5/10.6/10.7)",
          link: "http://erpdoccloud.com.br/downloads/20118101518076073.zip"
        }
      ]
    },
    {
      ...
      drivers: [
        {
          ...
          link: "http://erpdoccloud.com.br/downloads/safesign-3.0.93-32bits.msi"
        },
        {
          nome: "Safesign Standard 3.0.93 (64 Bits)",
          especificacao: "Driver do Cartão modelo novo para sistemas de 32 Bits (Windows Xp, Vista, 7 e 8)",
          link: "http://erpdoccloud.com.br/downloads/safesign-3.0.93-64bits.msi"
        }
      ]
    },
    {
      ...
      drivers: [
        {
          ...
          link: "http://erpdoccloud.com.br/downloads/TeamViewer_Setup.exe"
        },
        {
          nome: "All-In-One: TeamViewer versão completa ( Versão Mac )",
          link: "http://erpdoccloud.com.br/downloads/TeamViewer.dmg"
        },
        {
          nome: "All-In-One: TeamViewer versão completa ( Versão Linux )",
          link: "http://erpdoccloud.com.br/downloads/teamviewer_11.0.93329_i386.tar.xz"
        }
      ]
    },
    {
      ...
      drivers: [
        {
          ...
          link: "http://erpdoccloud.com.br/downloads/AWP_Manager_5.1.8_32_bits.exe"
        },
        {
          nome: "Windows (XP, 2003, 2008, Vista, Seven)",
          especificacao: "Driver para Microsoft Windows x86 (XP, 2003, 2008, Vista, Seven)",
          link: "http://erpdoccloud.com.br/downloads/AWP_Manager_5.1.8_64_bits.exe"
        }
      ]
    }
  ]
